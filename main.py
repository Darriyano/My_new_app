...
from data import db_session, news_api, new_resourses, users_resource
...
def main():
    ...
    api.add_resource(new_resourses.NewsResource, '/api/v2/news/<int:news_id>')
    api.add_resource(new_resourses.NewsListResource, '/api/v2/news')
